...
- **OKF (Open Knowledge Format)**: A strict markdown-based format (`.agent_brain/knowledge/*.md`) used to seamlessly inject persistent project rules, coding guidelines, and architectural constraints directly into the LLM's system prompt context.
